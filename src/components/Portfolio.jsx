...
import arrayDestruct from "../assets/portfolio/clone.jpg";
...
import reactSmooth from "../assets/portfolio/reactSmooth.webp";
...
const Portfolio = () => {
  const portfolios = [
    {
      id: 1,
      src: arrayDestruct,
      url : "https://effulgent-brigadeiros-47086e.netlify.app/"
    },
    {
      id: 2,
      src: reactParallax,
  ...
  return (
    <div
      name="portfolio"
      className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen sm:pt-24"
    >
